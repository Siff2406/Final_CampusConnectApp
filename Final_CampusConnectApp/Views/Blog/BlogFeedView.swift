                                            ...
                                            HStack {
                                                ...
                                                Button(action: {
                                                    ...
                                                    Text("Post")
                                                        ...
                                                        .padding(.vertical, 8)
                                                        .background(newPostContent.isEmpty ? Color.gray : Color.swuRed) // Use swuRed
                                                        .cornerRadius(20)
                                                }
            ...
            HStack(spacing: 20) {
                ...
                Button(action: {
                    ...
                    HStack(spacing: 6) {
                        Image(systemName: isLiked ? "heart.fill" : "heart")
                            .foregroundColor(isLiked ? .swuRed : .swuTextSecondary) // Changed to swuRed & swuTextSecondary
                        Text("\(post.likes)")
                            .font(.subheadline)
                            .foregroundColor(.swuTextSecondary) // Changed to swuTextSecondary
                    }
                ...
                NavigationLink(destination: CommentsView(post: post)) {
                    HStack(spacing: 6) {
                        ...
                        Text("\(post.commentCount)") // Show count
                            .font(.subheadline)
                    }
                    .foregroundColor(.swuTextSecondary) // Changed to swuTextSecondary
                }
